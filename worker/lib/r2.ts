...
export function sortArtifactFiles(files: ArtifactChild[]): ArtifactChild[] {
...
export async function listArtifactChildren(
    ...
    return { files: sortArtifactFiles(files), directories };
}
...
export async function listAllArtifactKeys(
    bucket: R2Bucket,
    artifactId: string,
